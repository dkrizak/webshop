					...
					<?php
						...
						if (sizeof($_SESSION['cart']) < 1) {
							...
							if ($max > $limit){
								...
								if ($page == 1)
								echo '<div id="previous"><h2>Previous</h2></div><div id="page"><h2>'.$page.'/'.$maxpage.'</h2></div><div id="next"><a href="cart.php?page='.($page + 1).'"><h2>Next</h2></a></div>';
								else if ($page == $maxpage)
								echo '<div id="previous"><a href="cart.php?page='.($page - 1).'"><h2>Previous</h2></a></div><div id="page"><h2>'.$page.'/'.$maxpage.'</h2></div><div id="next"><h2>Next</h2></div>';
								else
								echo '<div id="previous"><a href="cart.php?page='.($page - 1).'"><h2>Previous</h2></a></div><div id="page"><h2>'.$page.'/'.$maxpage.'</h2></div><div id="next"><a href="cart.php?page='.($page + 1).'"><h2>Next</h2></a></div>';
							}
